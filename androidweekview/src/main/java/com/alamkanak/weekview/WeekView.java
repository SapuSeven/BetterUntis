...
public final class WeekView<T> extends View
	...
	private void calculateWidthPerDay() {
		...
		drawConfig.widthPerDay = getWidth() - drawConfig.timeColumnWidth;
	...
	public int getHeaderRowSecondaryTextSize() {
		return config.headerRowSecondaryTextSize;
	}

	public void setHeaderRowSecondaryTextSize(int textSize) {
		config.headerRowSecondaryTextSize = textSize;
		invalidate();
	}
	...
	public boolean getEventTextBold() {
		return drawConfig.eventTextPaint.getTypeface().equals(Typeface.DEFAULT_BOLD);
	}

	public void setEventTextBold(boolean bold) {
		drawConfig.eventTextPaint.setTypeface(bold ? Typeface.DEFAULT_BOLD : Typeface.DEFAULT);
		invalidate();
	}
	...
	public boolean getEventSecondaryTextCentered() {
		return config.eventSecondaryTextCentered;
	}

	public void setEventSecondaryTextCentered(boolean eventSecondaryTextCentered) {
		config.setEventSecondaryTextCentered(eventSecondaryTextCentered);
		invalidate();
	}

	public int getEventSecondaryTextSize() {
		return config.eventSecondaryTextSize;
	}

	public void setEventSecondaryTextSize(int eventSecondaryTextSize) {
		config.setEventSecondaryTextSize(eventSecondaryTextSize);
		invalidate();
	}
	...
	public void goToHour(int hour) {
		...
		hour = (int) min(hour, config.hoursPerDay());
	...
	public void setOnCornerClickListener(TopLeftCornerClickListener listener) {
		gestureHandler.setTopLeftCornerClickListener(listener);
	}

	public TopLeftCornerClickListener getCornerClickListener() {
		return gestureHandler.getTopLeftCornerClickListener();
	}
	...
	public int[] getHourLines() {
		return config.hourLines;
	}

	public void setHourLines(int[] lines) {
