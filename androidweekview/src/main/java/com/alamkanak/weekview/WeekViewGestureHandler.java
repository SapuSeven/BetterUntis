...
final class WeekViewGestureHandler<T> extends GestureDetector.SimpleOnGestureListener {
	...
	private TopLeftCornerClickListener topLeftCornerClickListener;
	...
	private void onFlingHorizontal(float originalVelocityX) {
		...
		final int dayHeight = (int) (config.hourHeight * config.hoursPerDay());
	...
	public TopLeftCornerClickListener getTopLeftCornerClickListener() {
		return topLeftCornerClickListener;
	}

	public void setTopLeftCornerClickListener(TopLeftCornerClickListener topLeftCornerClickListener) {
		this.topLeftCornerClickListener = topLeftCornerClickListener;
	}

	public TopLeftCornerLongPressListener getTopLeftCornerLongPressListener() {
		return topLeftCornerLongPressListener;
	}

	public void setTopLeftCornerLongPressListener(TopLeftCornerLongPressListener topLeftCornerLongPressListener) {
		this.topLeftCornerLongPressListener = topLeftCornerLongPressListener;
	}
	...
	private void goToNearestOrigin() {
		...
		double leftDays = drawingConfig.currentOrigin.x;
		if (config.startOnFirstDay)
			leftDays /= totalDayWidth * config.numberOfVisibleDays;
		else
			leftDays /= totalDayWidth;
		...
		int nearestOrigin = (int) drawingConfig.currentOrigin.x;
		if (config.startOnFirstDay)
			nearestOrigin -= leftDays * totalDayWidth * config.numberOfVisibleDays;
		else
			nearestOrigin -= leftDays * totalDayWidth;
