...
private const val DATABASE_NAME = "roomfinder.db"

// BIG TODO: The commented code is from UserDatabase. Use it to get RoomfinderDatabase to save rooms in a database.
class RoomfinderDatabase private constructor(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
	companion object {
		const val COLUMN_NAME_USER_ID = "_user_id"

		private var instance: RoomfinderDatabase? = null

		fun createInstance(context: Context): RoomfinderDatabase {
			return instance ?: RoomfinderDatabase(context)
		}
	}
