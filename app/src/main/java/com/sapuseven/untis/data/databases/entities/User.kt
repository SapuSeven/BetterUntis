...
data class UserWithData(
	...
	@Relation(parentColumn = "id", entityColumn = "userId") val absenceReasons: List<AbsenceReason>,

	@Relation(parentColumn = "id", entityColumn = "userId") val departments: List<Department>,

	@Relation(parentColumn = "id", entityColumn = "userId") val duties: List<Duty>,
	...
	@Relation(parentColumn = "id", entityColumn = "userId") val holidays: List<Holiday>,

	@Relation(parentColumn = "id", entityColumn = "userId") val klassen: List<Klasse>,

	@Relation(parentColumn = "id", entityColumn = "userId") val rooms: List<Room>,

	@Relation(parentColumn = "id", entityColumn = "userId") val subjects: List<Subject>,
