...
import com.sapuseven.untis.data.databases.TABLE_NAME_TEACHING_METHODS
import com.sapuseven.untis.interfaces.TableModel
import kotlinx.serialization.Serializable

@Serializable
@Table(TABLE_NAME_TEACHING_METHODS)
data class TeachingMethod(
	...
	companion object {
		const val TABLE_NAME = TABLE_NAME_TEACHING_METHODS
	}
